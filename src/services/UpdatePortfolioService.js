  ...
  async execute({ nameChildren, portfolio_id, email }) {
    ...
    if (email) {
      ...
      await mailProvider.sendMail({
        ...
        body: `Olá você foi convidado para visualizar o portfolio de ${nameChildren}. Para visualizar o portfolio primeiro se cadastre com este email em Webfolio.com.br e acessar o link http://localhost:3333/portfolio/${portfolio_id}`,
      });
    }
